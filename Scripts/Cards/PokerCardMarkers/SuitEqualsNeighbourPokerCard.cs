...
public class SuitEqualsNeighbourPokerCard: RevealTriggeredPokerCard
{
    public Enums.Direction1D TargetDirection;
    
    public SuitEqualsNeighbourPokerCard(Enums.CardSuit cardSuit, Enums.CardFace face, Enums.CardRank rank,
        Enums.Direction1D targetDirection, BattleEntity owner = null, bool suitAsSecondComparer = false) : base(cardSuit, face, rank, owner, suitAsSecondComparer)
    {
